            ...
            body: ListView.separated(
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: ListTile(
                    title: Text('ReceiverEmail:  '+transactions[index].ReceiverID +'  '
                        ' RecevierID: '+ transactions[index].ReceiverEmail,style: TextStyle(color:Colors.black),),
                    subtitle:Text('Amount sent:   '+ transactions[index].Amount +'     '
                        '       Date:  '+transactions[index].dateTime, style: TextStyle(color:Colors.cyan[700]),),
